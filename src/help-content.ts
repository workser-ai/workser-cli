...
export const HELP_TOPICS: readonly HelpTopic[] = [
  {
    ...
    source: "skills/workser/reference/agent-cloud-api-calls.md",
    body: `# Giving an agent an API to call
...
`,
  },
  {
    ...
    commands: ["data"],
    source: "skills/workser/reference/data.md",
    body: `# Data from the web
